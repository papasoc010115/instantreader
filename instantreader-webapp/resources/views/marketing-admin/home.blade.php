...
<div class="content">
    ...
    <section class="forms">
        <div class="container-fluid">
            ...
            <!-- Image -->
            <form data-route="{{ route('home.store_media_single') }}" enctype="multipart/form-data" class="media">
                @csrf
                <div class="mb-3 py-3">
            ...
            <script>    
             ...
             <!-- Images of Section 7 -->
             <form data-route="{{ route('home.store_media_multiple') }}" enctype="multipart/form-data" class="media">
                @csrf
                <div class="mb-3 py-3">
