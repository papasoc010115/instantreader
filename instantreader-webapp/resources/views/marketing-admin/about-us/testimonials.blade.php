    ...
    <section class="forms">
        ...
        <form data-route="{{ route('about-us.testimonials.store_media_single') }}" data-progress_bar="testimonials-sect2-image4-bar" enctype="multipart/form-data" class="media">
            ...
            <div class="mb-3 py-3">
                ...
                <small id="sect2Image4Help" class="form-text text-muted">Recommended image size: 2048x1365 px ( 3:2 aspect ratio )</small>
        ...
        <form data-route="{{ route('about-us.testimonials.store_individual_testimonial') }}" enctype="multipart/form-data" class="testimonial">
            ...
            <div class="form-group py-3">
                ...
                <small id="sect3ImageHelp" class="form-text text-muted">Recommended image size: 500x500 px ( 1:1 aspect ratio )</small>
            ...
            <div class="col-lg-12">
                ...
                <form data-route="{{ route('about-us.testimonials.update_individual_testimonial') }}" enctype="multipart/form-data" class="testimonial">
                    ...
                    <div class="form-group py-3" class="existing-faq">
                        ...
                        <small id="sect4ImageHelp-{{ $testimonial->id }}" class="form-text text-muted">Recommended image size: 500x500 px ( 1:1 aspect ratio )</small>
