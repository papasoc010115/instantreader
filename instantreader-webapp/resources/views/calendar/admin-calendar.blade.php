...
<script>
    ...
    $(".day-card").on("click",function() {
        if($(this).hasClass("is-active")){
                    ...
                    if (date[0] == active_day_id){
                        for (let z=0; z<date[1].length; z++){
                            ...
                            if (date[1][z].slots > 0) {            
                                ...
                                let timeslot_text = document.createElement("div");
                                timeslot_text.id = "schedule_" + date[1][z].id;
                                timeslot_text.classList.add(
                                    "specific-time-card",
                                    "m-2",
                                    "d-flex",
                                    "align-items-center",
                                ...
                                delete_icon.id = "delete_" + date[1][z].id;
                                ...
                                timeslot_text.appendChild(delete_icon);
            ...
            // update the jquery for deleting time cards
            $(".delete-schedule").on("click", (e) => {
                const api_route = "{{ route('booking.delete_schedule') }}";
                let update_data = {
                    id: e.target.id.replace("delete_", "")
                };
